    ...
    function populateList(page, tasks) {
        ...
        for (var i = 0; i < tasks.length; i++) {
            ...
            if (task.Category != currentCategory) {
                ...
                html += "</h2>";
                if (i === 0) {
                    html += '<a is="emby-linkbutton" class="raised button-alt headerHelpButton" target="_blank" href="https://docs.veso.org/general/server/tasks.html">' + globalize.translate("Help") + "</a>";
                }
                html += "</div>";
